...
import com.example.todoapp.di.DatabaseModule_ProvideTaskDaoFactory;
import com.example.todoapp.di.DatabaseModule_ProvideTodoDatabaseFactory;
...
import com.example.todoapp.presentation.viewmodel.TaskViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerTodoApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends TodoApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return Collections.<String>singleton(TaskViewModel_HiltModules_KeyModule_ProvideFactory.provide());
    }
  ...
  private static final class ViewModelCImpl extends TodoApplication_HiltComponents.ViewModelC {
    ...
    private GetAllTasksUseCase getAllTasksUseCase() {
      return new GetAllTasksUseCase(singletonCImpl.bindTaskRepositoryProvider.get());
    }

    private GetCompletedTasksUseCase getCompletedTasksUseCase() {
      return new GetCompletedTasksUseCase(singletonCImpl.bindTaskRepositoryProvider.get());
    }
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.taskViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<String, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, javax.inject.Provider<ViewModel>>singletonMap("com.example.todoapp.presentation.viewmodel.TaskViewModel", ((Provider) taskViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.todoapp.presentation.viewmodel.TaskViewModel 
          return (T) new TaskViewModel(viewModelCImpl.getAllTasksUseCase(), viewModelCImpl.getCompletedTasksUseCase(), viewModelCImpl.addTaskUseCase(), viewModelCImpl.updateTaskUseCase(), viewModelCImpl.deleteTaskUseCase());
  ...
  private static final class SingletonCImpl extends TodoApplication_HiltComponents.SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.todoapp.data.repository.TaskRepositoryImpl 
          return (T) new TaskRepositoryImpl(singletonCImpl.provideTaskDaoProvider.get());

          case 1: // com.example.todoapp.data.local.dao.TaskDao 
          return (T) DatabaseModule_ProvideTaskDaoFactory.provideTaskDao(singletonCImpl.provideTodoDatabaseProvider.get());

          case 2: // com.example.todoapp.data.local.TodoDatabase 
